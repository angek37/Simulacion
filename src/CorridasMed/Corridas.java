...
public class Corridas {
	...
	public void Corrida(int[] c){
		...
		estadistico=((double)Co-esperado)/Math.sqrt(var);
		
		System.out.println("Corridas: "+Co+"\nCeros: "+n0+"\nUnos: "+n1+
				"\nNumeros: "+c.length+"\n"+"Valor esperado: "+esperado+
					"\nVarianza del número de corridas: "+var+
						"\nEstadistico: "+estadistico);
		if(estadistico<1.96 && estadistico>(-1.96)){
			System.out.println("Son independientes");
		}else{
			System.out.println("No son independientes");
		}
	}
